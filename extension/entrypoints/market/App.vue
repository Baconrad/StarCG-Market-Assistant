...
const magicCrystalRatio = ref<number>(STORAGE_DEFAULTS.magicCrystalRatio);
      ...
      <div class="flex items-center justify-between bg-[#e8d5c4] rounded-lg px-6 py-4 border border-[#d6b089]">
        ...
        <NavigationMenu>
          <NavigationMenuList class="flex gap-2">
            <NavigationMenuItem>
              <NavigationMenuLink
                :class="cn('bg-transparent hover:bg-[#d6b089] text-[#2b160e] px-4 py-2 rounded-md transition-colors', currentView === 'search' && 'bg-[#d6b089]')"
                href="#"
            ...
            <NavigationMenuItem>
              <NavigationMenuLink
                :class="cn('bg-transparent hover:bg-[#d6b089] text-[#2b160e] px-4 py-2 rounded-md transition-colors', currentView === 'tracked' && 'bg-[#d6b089]')"
                href="#"
                ...
                <ShadTableRow v-for="(record, idx) in selectedHistoryItem.historyData" :key="idx">
                  ...
                  <ShadTableCell class="text-center">
                    {{ new Intl.NumberFormat('en-US').format(
                      record.priceType === '1' ? record.price * magicCrystalRatio : record.price
                    ) }}
                  </ShadTableCell>
